...
class SizeOfStackCommit: PeElement<Either<DWord, QWord>> {
    ...
    constructor(headerOffset: QWord, magic: Word, file: RandomAccessFile) {
        peType = when (magic) {
            PE32_MAGIC -> PeType.Pe32(76, 4)
            PE32_PLUS_MAGIC -> PeType.Pe32Plus(80, 8)
    ...
    constructor(original: SizeOfStackCommit, newData: Either<DWord, QWord>) {
