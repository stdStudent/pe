...
class DelayImportDescriptor: DataDirectoryElement {
    override val data: QWord
    override val realOffset: QWord
    override val peType: PeType

    override val hex: String get() = data.hex
    override val realName = "Delay Import Descriptor"
    ...
    constructor(headerOffset: QWord, magic: Word, file: RandomAccessFile) {
        ...
        peType = when (magic) {
            PeType.Companion.PE32_MAGIC -> PeType.Pe32(200, size)
            PeType.Companion.PE32_PLUS_MAGIC -> PeType.Pe32Plus(216, size)
    ...
    constructor(original: DelayImportDescriptor, newData: QWord) {
        data = newData
