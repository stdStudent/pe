...
class Debug: DataDirectoryElement {
    ...
    constructor(headerOffset: QWord, magic: Word, file: RandomAccessFile) {
        ...
        peType = when (magic) {
            PeType.Companion.PE32_MAGIC -> PeType.Pe32(144, size)
            PeType.Companion.PE32_PLUS_MAGIC -> PeType.Pe32Plus(160, size)
    ...
    constructor(original: Debug, newData: QWord) {
        data = newData
