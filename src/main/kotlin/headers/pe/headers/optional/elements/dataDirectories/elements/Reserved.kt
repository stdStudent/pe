...
class Reserved: DataDirectoryElement {
    ...
    constructor(headerOffset: QWord, magic: Word, file: RandomAccessFile) {
        ...
        peType = when (magic) {
            PeType.Companion.PE32_MAGIC -> PeType.Pe32(216, size)
            PeType.Companion.PE32_PLUS_MAGIC -> PeType.Pe32Plus(232, size)
    ...
    constructor(original: Reserved, newData: QWord) {
        data = newData
