...
class ResourceTable: DataDirectoryElement {
    ...
    constructor(headerOffset: QWord, magic: Word, file: RandomAccessFile) {
        ...
        peType = when (magic) {
            PeType.Companion.PE32_MAGIC -> PeType.Pe32(112, size)
            PeType.Companion.PE32_PLUS_MAGIC -> PeType.Pe32Plus(128, size)
    ...
    constructor(original: ResourceTable, newData: QWord) {
        data = newData
