...
class GlobalPointer: DataDirectoryElement {
    ...
    constructor(headerOffset: QWord, magic: Word, file: RandomAccessFile) {
        ...
        peType = when (magic) {
            PeType.Companion.PE32_MAGIC -> PeType.Pe32(160, size)
            PeType.Companion.PE32_PLUS_MAGIC -> PeType.Pe32Plus(176, size)
    ...
    constructor(original: GlobalPointer, newData: QWord) {
        data = newData
