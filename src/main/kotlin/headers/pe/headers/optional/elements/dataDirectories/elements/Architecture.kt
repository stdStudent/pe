...
class Architecture: DataDirectoryElement {
    ...
    constructor(headerOffset: QWord, magic: Word, file: RandomAccessFile) {
        ...
        peType = when (magic) {
            PeType.Companion.PE32_MAGIC -> PeType.Pe32(152, size)
            PeType.Companion.PE32_PLUS_MAGIC -> PeType.Pe32Plus(168, size)
    ...
    constructor(original: Architecture, newData: QWord) {
        data = newData
