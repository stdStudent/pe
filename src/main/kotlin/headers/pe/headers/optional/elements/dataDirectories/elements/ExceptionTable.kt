...
class ExceptionTable: DataDirectoryElement {
    ...
    constructor(headerOffset: QWord, magic: Word, file: RandomAccessFile) {
        ...
        peType = when (magic) {
            PeType.Companion.PE32_MAGIC -> PeType.Pe32(120, size)
            PeType.Companion.PE32_PLUS_MAGIC -> PeType.Pe32Plus(136, size)
    ...
    constructor(original: ExceptionTable, newData: QWord) {
        data = newData
