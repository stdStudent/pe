...
class ImportAddressTable: DataDirectoryElement {
    override val data: QWord
    override val realOffset: QWord
    override val peType: PeType

    override val hex: String get() = data.hex
    override val realName = "Import Address Table [IAT]"
    ...
    constructor(headerOffset: QWord, magic: Word, file: RandomAccessFile) {
        ...
        peType = when (magic) {
            PeType.Companion.PE32_MAGIC -> PeType.Pe32(192, size)
            PeType.Companion.PE32_PLUS_MAGIC -> PeType.Pe32Plus(208, size)
    ...
    constructor(original: ImportAddressTable, newData: QWord) {
        data = newData
