...
class SizeOfHeapCommit: PeElement<Either<DWord, QWord>> {
    ...
    constructor(headerOffset: QWord, magic: Word, file: RandomAccessFile) {
        peType = when (magic) {
            PE32_MAGIC -> PeType.Pe32(84, 4)
            PE32_PLUS_MAGIC -> PeType.Pe32Plus(96, 8)
    ...
    constructor(original: SizeOfHeapCommit, newData: Either<DWord, QWord>) {
