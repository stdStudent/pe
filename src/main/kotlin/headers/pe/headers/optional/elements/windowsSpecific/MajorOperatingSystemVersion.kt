...
class MajorOperatingSystemVersion: PeElement<Word> {
    ...
    override val realName = "Major Operating System Version"
    ...
    constructor(original: MajorOperatingSystemVersion, newData: Word) {
        data = newData
